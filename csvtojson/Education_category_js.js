...
var instream = fs.createReadStream('../csv/India2011_Merge_csv.csv');
...
rl.on('close', function() {
    ...
    fs.writeFile('../json/education_category_json.json', JSON.stringify(arr, null, 2), 'utf8', function(error) {
        if (error) {
            console.log(error);
        }
    });
